...
const dropdownTemplate0 = (rowData, { rowIndex }) => <p >{rowData.name?.env}</p>
const pTemplate1 = (rowData, { rowIndex }) => <p >{rowData.dbservice}</p>
const pTemplate2 = (rowData, { rowIndex }) => <p >{rowData.typename}</p>
const pTemplate3 = (rowData, { rowIndex }) => <p >{rowData.githubrepolocation}</p>
...
<Column field="dbservice" header="Dbservice" body={pTemplate1} filter={selectedFilterFields.includes("dbservice")} hidden={selectedHideFields?.includes("dbservice")}  sortable style={{ minWidth: "8rem" }} />
<Column field="typename" header="Typename" body={pTemplate2} filter={selectedFilterFields.includes("typename")} hidden={selectedHideFields?.includes("typename")}  sortable style={{ minWidth: "8rem" }} />
<Column field="githubrepolocation" header="Githubrepolocation" body={pTemplate3} filter={selectedFilterFields.includes("githubrepolocation")} hidden={selectedHideFields?.includes("githubrepolocation")}  sortable style={{ minWidth: "8rem" }} />
