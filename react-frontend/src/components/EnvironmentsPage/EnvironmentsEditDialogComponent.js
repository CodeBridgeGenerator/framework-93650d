...
type: _entity?.type,
        ...
        await client.service("environments").patch(_entity._id, _data);
    ...
    return (
        <Dialog header="Edit Environments" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max" footer={renderFooter()} resizable={false}>
