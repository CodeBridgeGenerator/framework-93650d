...
import SingleEnvironmentsPage from "../components/EnvironmentsPage/SingleEnvironmentsPage";
import EnvironmentProjectLayoutPage from "../components/EnvironmentsPage/EnvironmentProjectLayoutPage";
import SingleSettingsPage from "../components/SettingsPage/SingleSettingsPage";
import SettingProjectLayoutPage from "../components/SettingsPage/SettingProjectLayoutPage";
import SingleProtocolPage from "../components/ProtocolPage/SingleProtocolPage";
import ProtocolProjectLayoutPage from "../components/ProtocolPage/ProtocolProjectLayoutPage";
...
import SingleCodechangesPage from "../components/CodechangesPage/SingleCodechangesPage";
import CodechangeProjectLayoutPage from "../components/CodechangesPage/CodechangeProjectLayoutPage";
import SingleChangesPage from "../components/ChangesPage/SingleChangesPage";
import ChangeProjectLayoutPage from "../components/ChangesPage/ChangeProjectLayoutPage";
...
import SingleServicechangesPage from "../components/ServicechangesPage/SingleServicechangesPage";
import ServicechangeProjectLayoutPage from "../components/ServicechangesPage/ServicechangeProjectLayoutPage";
// ~cb-add-import~
...
<Route path="/settings/:singleSettingsId" exact element={<SingleSettingsPage />} />
<Route path="/settings" exact element={<SettingProjectLayoutPage />} />
<Route path="/protocol/:singleProtocolId" exact element={<SingleProtocolPage />} />
<Route path="/protocol" exact element={<ProtocolProjectLayoutPage />} />
...
<Route path="/codechanges/:singleCodechangesId" exact element={<SingleCodechangesPage />} />
<Route path="/codechanges" exact element={<CodechangeProjectLayoutPage />} />
<Route path="/changes/:singleChangesId" exact element={<SingleChangesPage />} />
<Route path="/changes" exact element={<ChangeProjectLayoutPage />} />
...
<Route path="/servicechanges/:singleServicechangesId" exact element={<SingleServicechangesPage />} />
<Route path="/servicechanges" exact element={<ServicechangeProjectLayoutPage />} />
