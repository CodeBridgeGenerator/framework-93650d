...
const pTemplate0 = (rowData, { rowIndex }) => <p >{rowData.appName}</p>
...
<Column field="appName" header="AppName" body={pTemplate0} filter={selectedFilterFields.includes("appName")} hidden={selectedHideFields?.includes("appName")}  sortable style={{ minWidth: "8rem" }} />
