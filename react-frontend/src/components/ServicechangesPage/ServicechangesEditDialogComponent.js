...
typeofchanges: _entity?.typeofchanges,
        };

        setLoading(true);
        try {
            
        await client.service("servicechanges").patch(_entity._id, _data);
        ...
        props.onHide();
        props.alert({ type: "success", title: "Edit info", message: "Info servicechanges updated successfully" });
    ...
    return (
        <Dialog header="Edit Service Gen Changes" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max" footer={renderFooter()} resizable={false}>
            <div className="grid p-fluid overflow-y-auto"
            style={{ maxWidth: "55vw" }} role="servicechanges-edit-dialog-component">
