        ...
        <div className="col-12 flex flex-column align-items-center">
            <div className="col-10">
                <div className="flex align-items-center justify-content-start">
                    ...
                    <h3 className="m-0">Service Gen Template</h3>
                </div>
...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-primary">DestFolder</label><p className="m-0 ml-3" >{_entity?.destFolder}</p></div>
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-primary">DestFilename</label><p className="m-0 ml-3" >{_entity?.destFilename}</p></div>
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-primary">Customrelationship</label><p className="m-0 ml-3" >{_entity?.customrelationship}</p></div>
