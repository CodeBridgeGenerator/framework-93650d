...
typename: _entity?.typename,
githubrepolocation: _entity?.githubrepolocation,
        };
    ...
    return (
        <Dialog header="Edit App Gen Templates" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max" footer={renderFooter()} resizable={false}>
